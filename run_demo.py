...
def main():
    ...
    print(f"  • Estimated Fuel Burn:   {m.estimated_fuel_tons:.2f} Metric Tons (${m.estimated_fuel_cost_usd:,.2f} USD est.)")
    ...
    print(f"  • New Estimated Fuel:     {rm.estimated_fuel_tons:.2f} Metric Tons (${rm.estimated_fuel_cost_usd:,.2f} USD est.)")
